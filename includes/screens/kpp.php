<div class="wrap">
    ...
    <div class="kpp_block">
        ...
        <div class="kpp_plugin">
            ...
            <span class="links"><a href="<?= admin_url('plugin-install.php?tab=plugin-information&amp;plugin=rsskingpro&amp;TB_iframe=true&amp;width=600&amp;height=550'); ?>" class="thickbox" title="More information about RSS King Pro">Install</a></span>
        </div>
        <div class="kpp_plugin">
            <img src="<?= plugins_url('../images/kpp_dkp.jpg', dirname(__FILE__)) ?>" alt="Details King Pro" />
            <span class="title">Details King Pro</span>
            <span class="description"><?= __("Site details the way you need them", 'relkptext') ?></span>
            <span class="links"><a href="<?= admin_url('plugin-install.php?tab=plugin-information&amp;plugin=details-king-pro&amp;TB_iframe=true&amp;width=600&amp;height=550'); ?>" class="thickbox" title="<?= __("More information about", 'relkptext') ?> Details King Pro"><?= __("Install", 'relkptext') ?></a></span>
        </div>
        <div class="kpp_plugin">
            <img src="<?= plugins_url('../images/kpp_smtpkp.jpg', dirname(__FILE__)) ?>" alt="SMTP King Pro" />
            <span class="title">SMTP King Pro</span>
            <span class="description">Send mail from WP from your email</span>
            <span class="links"><a href="<?= admin_url('plugin-install.php?tab=plugin-information&amp;plugin=smtp-king-pro&amp;TB_iframe=true&amp;width=600&amp;height=550'); ?>" class="thickbox" title="More information about SMTP King Pro">Install</a></span>
        </div>
        <div class="kpp_plugin">
